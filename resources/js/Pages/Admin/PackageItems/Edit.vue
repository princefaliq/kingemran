...
const form = useForm({
    tour_package_id: props.packageItem.tour_package_id,
    type: props.packageItem.type,
    name: props.packageItem.name
})

const save = () => {
    form.put(route('admin.package-items.update', props.packageItem.id))
}
</script>

<template>
    <Head title="Edit Package Item" />
