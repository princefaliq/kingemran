...
const confirmDelete = (id, title) => {
    if (!window.Swal) {
        ...
        if (confirm(`Yakin hapus Page ${title}?`)) {
    ...
    window.Swal.fire({
        title: 'Yakin?',
        text: `Halaman dengan judul "${title}" akan dihapus permanen!`,
        icon: 'warning',
        ...
        <template #Toolbar>
            <div class="toolbar mb-5 mb-lg-7">
                ...
                <div class="d-flex align-items-center py-2 py-md-1">
                    ...
                    <Link :href="route('admin.pages.create')" class="btn btn-dark fw-bold">
                        Create
                    </Link>
                </div>
            </div>
                ...
                <div class="card h-md-100">
                    ...
                    <div class="card-header border-0 py-5">
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">List Pages</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive table-loading">
                            <table class="table table-striped table-rounded table-row-bordered border gs-5">
                                ...
                                <span class="badge badge-light-primary">
                                    ...
                                    <td class="align-middle">{{ page.created_at_formatted }}</td>
                                    <td class="text-end">
                                        <Link
                                        ...
                                        <button
                                            @click="confirmDelete(page.id, page.title)"
