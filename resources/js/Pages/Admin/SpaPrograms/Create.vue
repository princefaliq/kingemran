    ...
    reader.onload = () => {
        ...
        nextTick(() => {
            ...
            cropper = new Cropper(cropperImage.value, {
                aspectRatio: 1, // ✅ lingkaran / square untuk spa
                viewMode: 1,
                autoCropArea: 1,
                responsive: true,
                background: false,
...
const save = () => {
    form.post(route('admin.spa-programs.store'), {
        forceFormData: true
    })
}
            ...
            <div class="card-body">
                ...
                <form @submit.prevent="save">
                    ...
                    <div class="mb-5">
                        ...
                        <div v-if="form.errors.nama_paket" class="text-danger mt-2">
                    ...
                    <div class="mb-5">
                        ...
                        <div v-if="form.errors.deskripsi" class="text-danger mt-2">
                    ...
                    <div class="mb-5">
                        ...
                        <div v-if="form.errors.harga" class="text-danger mt-2">
                            {{ form.errors.harga }}
                        </div>
                    </div>
                    ...
                    <div class="mb-7">
                        ...
                        <div v-if="form.errors.gambar" class="text-danger mt-3">
                            {{ form.errors.gambar }}
                        </div>
                    </div>
