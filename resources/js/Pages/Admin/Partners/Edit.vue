...
const form = useForm({
    ...
    url: props.partner.url || '',
    logo: null,
    remove_logo: false,
    is_active: props.partner.is_active ?? true
})

const previewUrl = ref(props.partner.logo_url || null)
...
const save = () => {
    form
        ...
        .post(route('admin.partners.update', props.partner.id), {
            forceFormData: true
        })
}
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form @submit.prevent="save">
                    ...
                    <div class="mb-7">
                        <label class="form-label fw-semibold mb-3">Logo (1:1)</label>
